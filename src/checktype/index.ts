 ...
 * @LastEditors: Toby
 * @LastEditTime: 2020-06-16 14:21:50
 ...
 * @param expectType 
 */
function checkType(data: any, expectType: string): boolean {
	if (arguments.length < 2) return false;

	const typeString: string = getFullTypeName(expectType);
...
/**
 * get target type by [Object.prototype.toString.call]
 * @param data 
 * @returns 
 *  LowerCase String for type name
 * 
 *  eg. string | array | object | boolean | number | function | math | undefined | null | regexp | symbol | json | window | htmldocument | location | error | arguments | map | set | weakmap | weakset
 */
